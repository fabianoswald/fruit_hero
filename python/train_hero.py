...
ap.add_argument("-m", "--model", default="fruit_heroX.model", required=False,
                help="path to output model")
ap.add_argument("-l", "--labelbin", default="pickle/lbX.pickle", required=False,
